...
function tinhKetQuaDauGia(phienDauGia, cacMucToiDa, nguoiTraGiaId, mucToiDaMoi, cacBuocGia) {
  ...
  if (dauTien) {
    ...
    cacLuotGiaCongKhai.push({ bidderId: String(nguoiTraGiaId), price: gia, type: 'TRUC_TIEP' });
  } else {
    ...
    if (mucToiDa > mucToiDaCu) {
      ...
      cacLuotGiaCongKhai.push({ bidderId: String(nguoiTraGiaId), price: gia, type: 'TU_DONG' });
    } else {
      ...
      cacLuotGiaCongKhai.push({ bidderId: nguoiThangId, price: gia, type: 'TU_DONG' });
    }
  }
  ...
  if (cacLuotGiaCongKhai.length) cacLuotGiaCongKhai[cacLuotGiaCongKhai.length - 1].price = gia;
